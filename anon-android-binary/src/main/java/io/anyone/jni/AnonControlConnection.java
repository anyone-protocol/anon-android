...
/**
 * A connection to a running Anon process as specified in control-spec.txt.
 *
 * @see <a href="https://gitweb.torproject.org/torspec.git/tree/control-spec.txt#n257">torspec.git/control-spec.txt 3. Commands</a>
 * @noinspection unused
 */
public class AnonControlConnection implements AnonControlCommands {
    ...
    /**
     * Create a new AnonControlConnection to communicate with Anon over
     * a given socket.  After calling this constructor, it is typical to
     * call launchThread and authenticate. */
    public AnonControlConnection(Socket connection) throws IOException {
     ...
     */
    public AnonControlConnection(InputStream i, OutputStream o) {
        this(new InputStreamReader(i), new OutputStreamWriter(o));
    }

    public AnonControlConnection(Reader i, Writer o) {
        this.output = o;
    ...
    protected final ArrayList<ReplyLine> readReply() throws IOException {
        ...
        do {
            ...
            if (line == null) {
                ...
                // the connection to Anon has been closed!
                if (reply.isEmpty()) {
                    // nothing received so far, can exit cleanly
                    return reply;
                }
                // received half of a reply before the connection broke down
                throw new AnonControlSyntaxError("Connection to Anon " +
                        " broke down while receiving reply!");
            }
            if (debugOutput != null)
                debugOutput.println("<< "+line);
            if (line.length() < 4)
                throw new AnonControlSyntaxError("Line (\""+line+"\") too short");
    ...
    protected synchronized List<ReplyLine> sendAndWaitForResponse(String s,
        ...
        for (ReplyLine c : lst) {
            if (!c.status.startsWith("2"))
                throw new AnonControlError("Error reply: " + c.msg);
        }
    ...
    protected void handleEvent(ArrayList<ReplyLine> events) throws UnsupportedOperationException {
        ...
        for (ReplyLine line : events) {
            ...
            switch (tp) {
                ...
                case EVENT_DEBUG_MSG, EVENT_INFO_MSG, EVENT_NOTICE_MSG, EVENT_WARN_MSG,
                     EVENT_ERR_MSG -> handler.message(tp, rest);
                default -> handler.unrecognized(tp, rest);
            }
        }
    }
     ...
     * which writes out all messages passed between Anon and the controller.
     ...
     * events Anon delivers to this connection.  To make Anon send us
    ...
    /**
     * Add a {@link RawEventListener} to receive raw events from Anon.
     *
     * @see #removeRawEventListener(RawEventListener)
     */
    ...
    /**
     * Start a thread to react to Anon's responses in the background.
    ...
    protected void react() throws IOException {
        ...
        while (true) {
            ...
            if (lst.isEmpty()) {
                ...
                throw new IOException("Anon is no longer running");
            }
     ...
     * <p>
     * Anon behaves as though it had just read each of the key-value pairs
     ...
     * <ul>
     * <li>{@link AnonControlCommands#EVENT_CIRCUIT_STATUS}: "CIRC"</li>
     * <li>{@link AnonControlCommands#EVENT_CIRCUIT_STATUS_MINOR}: "CIRC_MINOR"</li>
     * <li>{@link AnonControlCommands#EVENT_STREAM_STATUS}: "STREAM"</li>
     * <li>{@link AnonControlCommands#EVENT_OR_CONN_STATUS}: "ORCONN"</li>
     * <li>{@link AnonControlCommands#EVENT_BANDWIDTH_USED}: "BW"</li>
     * <li>{@link AnonControlCommands#EVENT_DEBUG_MSG}: "DEBUG"</li>
     * <li>{@link AnonControlCommands#EVENT_INFO_MSG}: "INFO"</li>
     * <li>{@link AnonControlCommands#EVENT_NOTICE_MSG}: "NOTICE"</li>
     * <li>{@link AnonControlCommands#EVENT_WARN_MSG}: "WARN"</li>
     * <li>{@link AnonControlCommands#EVENT_ERR_MSG}: "ERR"</li>
     * <li>{@link AnonControlCommands#EVENT_NEW_DESC}: "NEWDESC"</li>
     * <li>{@link AnonControlCommands#EVENT_ADDRMAP}: "ADDRMAP"</li>
     * <li>{@link AnonControlCommands#EVENT_DESCCHANGED}: "DESCCHANGED"</li>
     * <li>{@link AnonControlCommands#EVENT_NS}: "NS"</li>
     * <li>{@link AnonControlCommands#EVENT_STATUS_GENERAL}: "STATUS_GENERAL"</li>
     * <li>{@link AnonControlCommands#EVENT_STATUS_CLIENT}: "STATUS_CLIENT"</li>
     * <li>{@link AnonControlCommands#EVENT_STATUS_SERVER}: "STATUS_SERVER"</li>
     * <li>{@link AnonControlCommands#EVENT_GUARD}: "GUARD"</li>
     * <li>{@link AnonControlCommands#EVENT_STREAM_BANDWIDTH_USED}: "STREAM_BW"</li>
     * <li>{@link AnonControlCommands#EVENT_CLIENTS_SEEN}: "CLIENTS_SEEN"</li>
     * <li>{@link AnonControlCommands#EVENT_BUILDTIMEOUT_SET}: "BUILDTIMEOUT_SET"</li>
     * <li>{@link AnonControlCommands#EVENT_GOT_SIGNAL}: "SIGNAL"</li>
     * <li>{@link AnonControlCommands#EVENT_CONF_CHANGED}: "CONF_CHANGED"</li>
     * <li>{@link AnonControlCommands#EVENT_CONN_BW}: "CONN_BW"</li>
     * <li>{@link AnonControlCommands#EVENT_CELL_STATS}: "CELL_STATS"</li>
     * <li>{@link AnonControlCommands#EVENT_CIRC_BANDWIDTH_USED}: "CIRC_BW"</li>
     * <li>{@link AnonControlCommands#EVENT_TRANSPORT_LAUNCHED}: "TRANSPORT_LAUNCHED"</li>
     * <li>{@link AnonControlCommands#EVENT_HS_DESC}: "HS_DESC"</li>
     * <li>{@link AnonControlCommands#EVENT_NETWORK_LIVENESS}: "NETWORK_LIVENESS"</li>
     * </ul>
    ...
    /**
     * Authenticates the controller to the Anon server.
     * <p>
     * By default, the current Anon implementation trusts all local users, and
     * the controller can authenticate itself by calling authenticate(new byte[0]).
     * <p>
     * If the 'CookieAuthentication' option is true, Anon writes a "magic cookie"
     ...
     * {@code anon --hash-password <password>}
     * or by using the provided {@link PasswordDigest} class.
     * To authenticate under this scheme, the controller sends Anon the original
    ...
    /**
     * Instructs the server to write out its configuration options into its anonrc.
     *
    ...
    /**
     * Sends a signal from the controller to the Anon server.
     ...
     * @see #signal(String)
     */
    public void shutdownAnon(String signal) throws IOException {
    ...
    /**
     * Tells Anon to exit when this control connection is closed. This command
    ...
    /**
     * Tells the Anon server that future SOCKS requests for connections to a set of original
     ...
     * address.
     * <p>
     * Mappings set by the controller last until the Anon process exits:
    ...
    /**
     * Informs the Anon server that the stream specified by <b>streamID</b> should be
     ...
     * returned to Anon.
     * <p>
     * By default, Anon automatically attaches streams to
     * circuits itself, unless the configuration variable
     * "__LeaveStreamsUnattached" is set to "1".  Attempting to attach streams
     * via TC when "__LeaveStreamsUnattached" is false may cause a race between
     * Anon and the controller, as both attempt to attach streams to circuits.
     *
    ...
    /**
     * Tells Anon about the server descriptor in <b>desc</b>.
     * <p>
    ...
    /**
     * Tells Anon to change the exit address of the stream identified by <b>streamID</b>
    ...
    /**
     * Tells Anon to close the stream identified by <b>streamID</b>.
     * <b>reason</b> should be one of the Anon RELAY_END reasons given in tor-spec.txt, as a decimal:
     * <ul>
     ...
     * <li>13 -- REASON_TORPROTOCOL    (Sent when closing connection because of Anon protocol violations)</li>
     * </ul>
     * <p>
     * Anon may hold the stream open for a while to flush any data that is pending.
     *
    ...
    /**
     * Tells Anon to close the circuit identified by <b>circID</b>.
    ...
    public void useFeature(Collection<String> keys) throws IOException {
        ...
        StringBuilder b = new StringBuilder(USEFEATURE);
    ...
    public void protocolInfo(Collection<String> keys) throws IOException {
        ...
        StringBuilder b = new StringBuilder(PROTOCOLINFO);
    ...
    public void hsFetch(String address, List<String> servers) throws IOException {
        StringBuilder b = new StringBuilder(HSFETCH);
    ...
    public void hsPost(List<String> servers, String hsAddress, String descriptor) throws IOException {
        StringBuilder b = new StringBuilder(HSPOST);
        ...
        if (hsAddress != null && !hsAddress.isEmpty()) {
    ...
    /**
     * Tells Anon to generate and set up a new onion service using the best
     * supported algorithm.
     * <p>
    ...
    /**
     * Tells Anon to set up an onion service using the provided private key.
     * <p>
     * ADD_ONION was added in Tor 0.2.7.1-alpha.
     *
     * @see #addOnion(Map)
    ...
    /**
     * Tells Anon to set up an onion service.
     * <p>
     * ADD_ONION was added in Tor 0.2.7.1-alpha.
     *
     * @see #addOnion(Map)
    ...
    public Map<String,String> addOnion(String privKey,
        ...
        if (portLines == null || portLines.isEmpty())
    ...
    /**
     * Tells Anon to take down an onion service previously set up with
    ...
    /**
     * Tells the connected Anon to add client-side v3 client auth
    ...
    /**
     * Tells the connected Anon to remove the client-side v3 client
    ...
    /**
     * Tells the connected Anon to list all the stored client-side v3
